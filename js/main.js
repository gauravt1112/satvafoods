...
/*	$('.planning2').imageScroll();*/
	...
	$("<select />").appendTo("nav#displaymenu div");
	...
	}).appendTo("nav#displaymenu select");	

	

	// Populate dropdowns with the first menu items

	$("nav#displaymenu li a").each(function() {
	...
	//make responsive dropdown menu actually work			
  	...
  	$("nav#displaymenu select").change(function() {
